...
public class MyGridView extends View {
	...
	private float[] f; 
	private boolean clearArrayList = false; 
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.v(UpdateView2Activity.MYTAG, "onDraw width is: "+width+" , height is:+"+height);
		Log.v(UpdateView2Activity.MYTAG, "width/20 : "+width/10+ " height/20 : "+ height/10);  
		...
		if(arrayList != null)
		{
			...
			//clear out the array list if needed
			if(clearArrayList) 
			{
				arrayList.clear();
				clearArrayList=false; 
			}
		}
